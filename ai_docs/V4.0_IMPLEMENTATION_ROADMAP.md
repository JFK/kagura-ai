...
2025-10 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 2026-06
   │                                                        │
   v4.0.0-alpha ──▶ v4.0.0 ──▶ v4.1.0 ──▶ v4.2.0-beta ──▶ v4.2.0
   (1M)           (3M)        (6M)       (10M)            (12M)

   Phase A         Phase B     Phase C     Phase D         Phase E
   MCP First      GraphDB     Self-API    Consumer App    Cloud
```
...
## 🚀 Phase A: MCP-First Foundation (v4.0.0-alpha)

**期間**: Week 1-4 (1 month)
**Goal**: MCPをコアに据えた基盤実装
**Target Release**: v4.0.0-alpha
...
**Issue**: [#XXX] Release v4.0.0-alpha
...
## 🕸️ Phase B: GraphMemory & Consolidation (v4.0.0)

**期間**: Week 5-12 (2 months)
**Goal**: GraphMemory統合、Consolidation実装
...
## 🌐 Phase C: Self-hosted API & Connectors (v4.1.0)

**期間**: Week 13-20 (2 months)
