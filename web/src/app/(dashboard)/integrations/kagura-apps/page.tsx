  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">App Credentials</h1>
        ...
        {showGuide && (
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <h3 className="font-semibold text-sm">For ChatGPT Apps:</h3>
              <ol className="list-decimal list-inside space-y-1 text-sm text-slate-600 dark:text-slate-400 ml-2">
                <li>Create OAuth2 client with redirect URI: <code className="text-xs bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">https://chat.openai.com/aip/oauth/callback</code></li>
                <li>Copy Client ID and Client Secret</li>
                <li>In ChatGPT settings, configure OAuth2 with these credentials</li>
                <li>Set Authorization URL: <code className="text-xs bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">{typeof window !== 'undefined' ? window.location.origin : ''}/auth/oauth2/authorize</code></li>
                <li>Set Token URL: <code className="text-xs bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">{typeof window !== 'undefined' ? window.location.origin : ''}/auth/oauth2/token</code></li>
              </ol>
            </div>

            <div className="space-y-2">
              <h3 className="font-semibold text-sm">For Claude Desktop:</h3>
              <ol className="list-decimal list-inside space-y-1 text-sm text-slate-600 dark:text-slate-400 ml-2">
                <li>Create OAuth2 client with redirect URI: <code className="text-xs bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">http://localhost:3000/callback</code></li>
                <li>Edit Claude Desktop config file (<code>~/.config/claude/config.json</code>)</li>
